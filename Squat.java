/**
 * This is the Squat subclass of the app
 */
public class Squat extends Endurance{
	...
	public Squat(){
		super();
		this.musclesInExercise = new Muscle[] {Muscle.Glutes, Muscle.Abs, Muscle.Back};
		this.description = "Squat";
	} 
	...
	public double calorieLoss(Intensity intensity, double weight, int duration){
		...
		if ((this.intensity.getIntensityLevel()).equals("Low")){
			...
			this.intensityConstant = 7.0;
			return 7 * this.weight * (this.duration / 60.0);
		}	
	}
